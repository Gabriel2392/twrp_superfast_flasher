...
${CROSS}-clang++ *.cpp -o update-binary -O3 -std=c++20 -static -s -L. -larchive -lzstd -lz -llzma -llz4 -static-libstdc++ -I${libarchive}/libarchive -I${liblz4}/lib -I${libzstd}/lib -Wall -Wextra -llzma -I${liblzma}/src/liblzma/api
